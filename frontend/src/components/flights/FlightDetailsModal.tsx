            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col items-start gap-4 lg:items-end">
                ...
                <div className="text-right">
                  ...
                  <h3 className="mt-2 text-4xl font-bold text-emerald-300">
          ...
          >
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              ...
              <div>
                ...
                <h3 className="mt-6 text-3xl font-bold text-blue-700 dark:text-blue-300">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="mt-6 h-32 w-px bg-border lg:hidden" />
              ...
              <div className="lg:text-right">
                ...
                <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 lg:justify-end">
                ...
                <p className="mt-3 flex items-center gap-2 text-muted-foreground lg:justify-end">
          ...
          <div className="mb-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              ...
              <InfoCard
                icon={<Ticket size={22} />}
                title="Cabin Class"
                value={flight.cabin_class.replaceAll("_", " ")}
              />
              ...
              <InfoCard
                ...
                title="Refundable"
                value={flight.refundable ? "Yes" : "No"}
              />
